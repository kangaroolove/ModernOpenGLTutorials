...
int main(int argc, char** argv)
{
	...
	unsigned char* data = stbi_load("res/wood.jpg", &pictureWidth, &pictureHeight, &nrChannels, 0);
	if (data)
	{
		glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, pictureWidth, pictureHeight, 0, GL_RGB, GL_UNSIGNED_BYTE, data);
